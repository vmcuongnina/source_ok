...
<form name="frm" method="post" action="index.php?com=chinhanh&act=save_photo&id=<?=$_REQUEST['id'];?>&idc=<?=$_REQUEST['idc']?>" enctype="multipart/form-data" class="nhaplieu">
...
<b>Số thứ tự </b> <input type="text" name="stt" value="<?=$item['stt']?>" style="width:30px" />	<br />
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=chinhanh&act=man_photo'" class="btn" />
</form>