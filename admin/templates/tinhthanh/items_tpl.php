<h3><a href="index.php?com=tinhthanh&act=add">Quận Huyện</a>&nbsp;&nbsp;&nbsp;Danh mục Tỉnh Thành&nbsp;<?=get_main_category();?></h3>
<script language="javascript">
	function select_onchange()
	{
		var a=document.getElementById("id_cat");
		window.location ="index.php?com=tinhthanh&act=man&id_cat="+a.value;	
		return true;
	}
</script>
<?php
...
<table class="blue_table">
	<tr>
        ...
        <th style="width:36%;">Tỉnh Thành</th>
		<th style="width:736%;">Quận Huyện</th>
	...
	<tr>
		...
		<td style="width:36%;"><?=$items[$i]['ten']?></td>
		<td style="width:6%;">
		...
		<td style="width:6%;"><a href="index.php?com=tinhthanh&act=edit&id=<?=$items[$i]['id']?>"><img src="media/images/edit.png" border="0" /></a></td>
		<td style="width:6%;"><a href="index.php?com=tinhthanh&act=delete&id=<?=$items[$i]['id']?>" onClick="if(!confirm('Xác nhận xóa')) return false;"><img src="media/images/delete.png" border="0" /></a></td>
	</tr>
	<?php	}?>
</table>
<a href="index.php?com=tinhthanh&act=add"><img src="media/images/add.jpg" border="0"  /></a>
