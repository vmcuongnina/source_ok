...
<?php if($config_images=='true'){ ?>
	<div class="formRow">
		...
		<div class="formRow">
			...
			<div class="mt10"><img src="<?=_upload_hinhanh.$item['thumb']?>"  alt="NO PHOTO"  /></div>
			</div>
			<div class="clear"></div>
		</div>
<?php } ?>
...
<?php if($config_mota=='true'){ ?>
		<div class="formRow">
			...
			<div class="formRight">
                <textarea rows="8" cols="" title="Nhập mô tả . " class="tipS" name="data[mota_<?=$key?>]"><?=@$item['mota_'.$key]?></textarea>
			</div>
			<div class="clear"></div>
		</div>
<?php } ?>
<?php if($config_mota2=='true'){ ?>
		<div class="formRow">
			<label>Mô tả <?=$key!=$config['lang_active']?'('.$key.')':''?></label>
			<div class="ck_editor">
                <textarea id="mota_<?=$key?>" cols="" title="Nhập mô tả . " class="tipS" name="data[mota_<?=$key?>]"><?=@$item['mota_'.$key]?></textarea>
			</div>
			<div class="clear"></div>
		</div>
<?php } ?>
