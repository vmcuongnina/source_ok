...
<div class="widget">
  ...
  <div class="formRow">
    ...
    <div class="formRow">
      ...
      <div class="formRight">
          <div class="mt10">
            <a target="_blank" href="<?=_upload_file.@$item['file']?>"><?=@$item['file']?></a>
            <?php if(!empty($item['file'])){ ?>
            <a class="del_file" href="javascript:void(0);" rel="<?=$item['id']?>" style="color: red; margin-left: 15px;">[xóa file này]</a>
          <?php } ?>
          </div>
      </div>
      <div class="clear"></div>
