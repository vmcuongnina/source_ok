  ...
  <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
    ...
    <tbody>
       ...
       <td>
        ...
        <?php if($config_imgcolor=='true'){ ?>
        <td class="center">
          <a class="blueB" href="index.php?com=product&act=man_imgcolor&id_product=<?=$items[$i]['id']?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>">Thêm thuộc tính</a>
        </td>
        <?php } ?>
        <td align="center">
        ...
        <?php if($config_moi=='true'){ ?>
        <td align="center">
          <a data-val2="table_<?=$_GET['com']?>" rel="<?=$items[$i]['new']?>" data-val3="new" title class="status smallButton tipS" original-title="<?php if($items[$i]['new']==0) echo 'Click để hiện'; else echo "Click để ẩn"; ?>" data-val0="<?=$items[$i]['id']?>" >
        ...
        <?php if($config_khuyenmai=='true'){ ?>
        <td align="center">
          <a data-val2="table_<?=$_GET['com']?>" rel="<?=$items[$i]['km']?>" data-val3="km" title class="status smallButton tipS" original-title="<?php if($items[$i]['km']==0) echo 'Click để hiện'; else echo "Click để ẩn"; ?>" data-val0="<?=$items[$i]['id']?>" >
            <?php if($items[$i]['km']==1) { ?>
            <img src="./images/icons/color/tick.png" alt="">
            <?php }else{ ?>
            <img src="./images/icons/color/hide.png" alt="">
