  ...
  <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
    <thead>
      <tr>
        ...
        <?php } ?>
        <?php if($config_slider=="true"){ ?>
        <td class="tb_data_small">Show slider</td>
        <?php } ?>
    ...
    <tbody>
      ...
      <?php if($config_slider=="true"){ ?>
        <td align="center">
          <a data-val2="table_<?=$_GET['com']?>_list" rel="<?=$items[$i]['slider']?>" data-val3="slider" title class="status smallButton tipS" original-title="<?php if($items[$i]['slider']==0) echo 'Click để hiện'; else echo "Click để ẩn"; ?>" data-val0="<?=$items[$i]['id']?>" >
            <?php if($items[$i]['slider']==1) { ?>
            <img src="./images/icons/color/tick.png" alt="">
            <?php }else{ ?>
            <img src="./images/icons/color/hide.png" alt="">
            <?php } ?>
