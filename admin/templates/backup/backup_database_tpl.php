...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	            <li><a href="index.php?com=backup&act=backup_database"><span>Backup</span></a></li>
                                    <li class="current"><a href="#" onclick="return false;">Backup Database</a></li>
        </ul>
        <div class="clear"></div>
    </div>
</div>
...
<form name="supplier" id="validate" class="form" action="" method="post" enctype="multipart/form-data">
	<div class="widget">
		...
		<div class="formRow">
			<div class="formRight">
            	<input type="button" class="blueB" onclick="TreeFilterChanged2(); return false;" value="Backup Database" />
			</div>
			<div class="clear"></div>
		</div>
